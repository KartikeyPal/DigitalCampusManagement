    ...
    return (
        <div className="min-h-screen bg-[#09090b] text-zinc-50 font-sans flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <div className="mb-8 inline-flex items-center rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1 text-sm font-medium text-red-400 backdrop-blur-sm">
